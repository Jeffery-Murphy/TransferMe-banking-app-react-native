    ...
    <View className="flex-1 bg-[#FFFFFF]">
      <View className="flex-1 px-6 justify-center" style={{ marginTop: statusBarHeight }}>
        <View>
          ...
          <Text className="text-[35px] mt-2 font-bold">Login</Text>
        </View>
        ...
        <View className="self-center mt-12">
          <Button title="Log In" onPress={() => router.push("/Signup")} />
        </View>
        ...
        <View className="flex-row items-center mt-12 justify-center space-x-1">
            <Text className="text-[#878787]">Don't have an account?</Text>
            <TouchableOpacity onPress={() => router.push("/Signup")} activeOpacity={1}>
                <Text className="text-[#5063BF] font-medium underline">Sign Up</Text>
            </TouchableOpacity>
        </View>
      </View>
    </View>
